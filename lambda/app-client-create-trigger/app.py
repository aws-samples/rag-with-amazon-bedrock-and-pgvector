...
QUEUE_URL_ENV_VAR = "TRIGGER_QUEUE"
...
def _extract_valid_event(event):
    ...
    _validate_field(event_detail, "eventName", "CreateUserPoolClient")
...
def lambda_handler(event, context):
    ...
    rds_ddl_queue_url = os.environ.get(QUEUE_URL_ENV_VAR)
    if not rds_ddl_queue_url:
        raise MissingEnvironmentVariable(
            f"{QUEUE_URL_ENV_VAR} environment variable is required")
    
    # send message to Triggering Queue
